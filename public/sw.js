...
const CACHE='parcele-shell-v2';
const SHELL=['/teren.html','/teren.css','/teren.js','/geo.js','/geosrbija.js','/field-geo.js','/sample.json','/favicon.svg','/icon-192.png','/icon-512.png','/manifest.webmanifest'];
