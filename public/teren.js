...
function draw(){
 $('clearSelection').hidden=!current;$('details').hidden=!current;$('fit').textContent=current?'▱ Prikaži parcelu':mapPin&&!nearby.length?'◎ Prikaži pin':'▱ Prikaži parcele';
